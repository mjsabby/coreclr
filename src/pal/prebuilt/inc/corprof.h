...
typedef HRESULT __stdcall __stdcall ThreadSamplingCallback( 
    ThreadID threadId,
    FunctionID funcId,
    UINT_PTR ip);
...
enum __MIDL___MIDL_itf_corprof_0000_0000_0010
    {
        ...
        COR_PRF_SUSPEND_FOR_STACK_SAMPLING	= 9
...
EXTERN_C const IID IID_ICorProfilerInfo9;
    ...
    MIDL_INTERFACE("3EEE799A-8AD1-483E-86AB-04B58702A3C7")
    ICorProfilerInfo9 : public ICorProfilerInfo8
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE GetThreadStackSamples( 
            /* [in] */ ThreadSamplingCallback *pFunc) = 0;
    ...
    typedef struct ICorProfilerInfo9Vtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *GetThreadStackSamples )( 
            ICorProfilerInfo9 * This,
            /* [in] */ ThreadSamplingCallback *pFunc);
...
#define ICorProfilerInfo9_GetThreadStackSamples(This,pFunc)	\
    ( (This)->lpVtbl -> GetThreadStackSamples(This,pFunc) ) 
